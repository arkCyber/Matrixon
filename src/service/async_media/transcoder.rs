// =============================================================================
// Matrixon Matrix NextServer - Transcoder Module
// =============================================================================
//
...
impl MediaTranscoder {
    pub async fn new(_config: &crate::service::async_media::AsyncMediaConfig) -> Result<Self> {
        Ok(Self)
    }

    pub async fn transcode_file(&self, _input: &std::path::Path, _output: Option<&std::path::Path>) -> Result<crate::service::async_media::ScanResults> {
        Ok(crate::service::async_media::ScanResults {
            is_safe: true,
