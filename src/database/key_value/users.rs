// =============================================================================
// Matrixon Matrix NextServer - Users Module
// =============================================================================
//
...
impl service::users::Data for KeyValueDatabase {
    ...
    fn add_cross_signing_keys(
        ...
        if let Some(self_signing_key) = self_signing_key {
            ...
            let self_signing_key_id = self_signing_key_ids.next().ok_or(Error::BadRequestString(
                ErrorKind::InvalidParam,
        ...
        if let Some(user_signing_key) = user_signing_key {
            ...
            let user_signing_key_id = user_signing_key_ids.next().ok_or(Error::BadRequestString(
                ErrorKind::InvalidParam,
    ...
    fn sign_key(
        ...
        let mut cross_signing_key: serde_json::Value =
            serde_json::from_slice(&self.keyid_key.get(&key)?.ok_or(Error::BadRequestString(
                ErrorKind::InvalidParam,
    ...
    fn parse_master_key(
        ...
        let master_key_id = master_key_ids.next().ok_or(Error::BadRequestString(
            ErrorKind::InvalidParam,
